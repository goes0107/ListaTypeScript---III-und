...
export function questao5array(): void {
    ...
    function gerenciar_tarefas(): void {
        ...
        let opc: number = Number(prompt("1 - Adicionar | 2 - Concluir | 3 - Exibir | 4 - Sair"))
        ...
        while (opc !== 4) {
            ...
            switch (opc) {
                ...
                case 1:
                    let tarefa = String(prompt("Digite a tarefa: ")).toLowerCase()
                    tarefas.push(tarefa)
                    console.log("Tarefa adicionada!")
                    break

                case 2:
                    let concluir = String(prompt("Digite a tarefa a concluir: ")).toLowerCase()
                    let indice = tarefas.indexOf(concluir)
            ...
            opc = Number(prompt("1 - Adicionar | 2 - Concluir | 3 - Exibir | 4 - Sair"))
        }
    }
